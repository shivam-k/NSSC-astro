...
if(is_uploaded_file($_FILES['entry_img']['tmp_name']) && getimagesize($_FILES['entry_img']['tmp_name']) != false)
    ...
    $_SESSION["ename"] = $ename;
      ...
      <?php  
        ...
        throw new Exception("<script>alert('File Size Error. Make sure you are uploading correct format of image below 5MB.');</script>");
        }
    }
else
    {
...
?>
	...
	<div id="envelope" style="background-color: rgba(0,0,0,0.6);" style="">
		<header style="padding-right: 20px; padding-left: 20px">
		    ...
		    <p>Under the blanket of beautiful stars, we all witness the exquisite beauty of universe which hides boundless   mysteries underneath. To provide a platform to all amateur photographers across the nation to showcase their photography skills, NSSC’16 presents ASTOPHOTOGRAPHY. Winning photos will also be displayed in an exhibition in NSSC &#39;16.</p>
		</header>
		...
		<form enctype="multipart/form-data" action="<?php echo htmlentities($_SERVER['PHP_SELF']);?>" method="post" onsubmit="document.getElementById('submit').disabled=true; document.getElementById('submit').value='Submitting, please wait...';">  
		    ...
		    <input type="submit" value="Proceed to Next Page to Upload Image" id="submit">
